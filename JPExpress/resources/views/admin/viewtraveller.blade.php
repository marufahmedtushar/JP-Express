        ...
        <div class="card card-custom gutter-b">
            ...
            <div class="card-header border-0 py-5">
                ...
                <div class="card-toolbar">
                    <a href="createtraveller" class="btn btn-info font-weight-bolder font-size-sm">Create New Traveler</a>
                </div>
            </div>
            <!--end::Header-->
                    ...
                    <table class="table table-head-custom table-vertical-center" id="travelertable">
                        ...
                        @foreach($traveler as $travelers)
                            <tr>
                                ...
                                <td class="pl-0">
                                    <a href="#" class="text-dark-75 font-weight-bolder text-hover-primary font-size-lg">{{$travelers->id}}</a>
                                </td>
                                <td>
                                    <span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$travelers->name}}</span>
                                </td>
                                ...
                                <td class="pr-0 text-right">
                                    ...
                                    <a href="/traveleredit/{{$travelers->id}}" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3">
