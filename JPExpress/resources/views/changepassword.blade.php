                            ...
                            <div class="d-flex align-items-center">
                                <div
                                    ...
                                    <div class="symbol-label"
                                         style="background-image:url('admintemplate/assets/media/users/blank.png')"></div>
                                    <i class="symbol-badge bg-success"></i>
                                </div>
                                <div>
                                    <a href="#"
                                       class="font-weight-bolder font-size-h5 text-dark-75 text-hover-primary">{{Auth::user()->name}}</a>
                                    <div class="text-muted">User Type :{{Auth::user()->user_type}}</div>
                                    <div class="mt-2">
                            ...
                            <div class="navi navi-bold navi-hover navi-active navi-link-rounded">
                                ...
                                <div class="navi-item mb-2">
                                    <a href="profileoverview"
                                       class="navi-link py-4 {{ 'profileoverview' == request()->path() ? 'active' : '' }}">
                                ...
                                <div class="navi-item mb-2">
                                    <a href="changepassword" class="navi-link py-4 {{ 'changepassword' == request()->path() ? 'active' : '' }}">
                        ...
                        <!--end::Header-->
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <label class="col-xl-3 col-lg-3 col-form-label text-alert">Old Password</label>
                                    <div class="col-lg-9 col-xl-6">
                                        <input id="password" type="password" class="form-control form-control-lg form-control-solid mb-2 @error('password') is-invalid @enderror" value="" name="oldpassword" placeholder="Old password" />
                                        @if (count($errors))
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <input type="password" class="form-control form-control-lg form-control-solid" value="" name="newpassword" placeholder="New password" />
